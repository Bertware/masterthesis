...
Tijdens dit onderzoek zal geprobeerd worden om zowel de \foreign{service delivery} als \foreign{perceived service} te vergelijken tussen de twee technieken. Door deze vergelijking zal vastgesteld kunnen worden of Linked Connections een betere user-perceived performance biedt, zowel absoluut als relatief ten opzichte van de werkelijke performance.
...
Om te voorkomen dat de keuze van de geteste stations of routes de objectieve metingen vertekent, zullen de opzoekingen van echte gebruikers gebruikt worden. Hiervoor worden de log data van api.irail.be gebruikt, die publiek beschikbaar zijn\footnote{https://gtfs.irail.be/logs}. Door deze \foreign{queries} opnieuw af te spelen op de applicaties kan een zo goed mogelijk beeld verkregen worden van de werkelijke prestaties.
