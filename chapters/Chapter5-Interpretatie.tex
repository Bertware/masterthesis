...
Hierbij komt ook nog dat toestellen die over minder processorkracht beschikken, ook vaak over minder geheugen beschikken. Hierbij kunnen fabrikanten kiezen om de \foreign{garbage collection} agressiever in te stellen, wat leid tot efficiënter geheugengebruik ten koste van prestaties. %TODO: citation needed
